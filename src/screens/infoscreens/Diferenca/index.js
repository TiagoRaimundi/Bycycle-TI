  ...
  return (
    <ScrollView>
      ...
      >
        ...
        <Text style={styles.title}>Tipos de Ciclo</Text>
        {items.map((item, index) => (
          <TouchableOpacity key={index} style={styles.button} onPress={() => navigation.navigate('ItemDetailsDif', { item })}>
